...
class StickEd():
    ...
    def __init__(self, par, cb, head = None, body = None):
        ...
        hbox2 = Gtk.HBox(); hbox2.pack_start(lab1, False , 0, 0)
        ...
        self.spacer(hbox3)
        vbox.pack_start(hbox3, False , 0, 0)
        hbox4 = Gtk.HBox();
        self.spacer(hbox4)

        self.vspacer(vbox)
        lab2 = Gtk.Label(label="  Text:")
        hbox2b = Gtk.HBox(); hbox2b.pack_start(lab2, False , 0, 0)
        vbox.pack_start(hbox2b, False , 0, 0)
        self.vspacer(vbox)
    ...
    def spacer(self, hbox, xstr = "    "):
        ...
        hbox.pack_start(lab, False , 0, 0)

    def vspacer(self, vbox):
        lab = Gtk.Label(label=" ")
        vbox.pack_start(lab, False , 0, 0)
