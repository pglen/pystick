...
class MainWin():
    ...
    def __init__(self):
        ...
        butt1 = Gtk.Button.new_with_mnemonic(" _New Sticky ")
        butt1.connect("clicked", self.show_new, window)
        hbox.pack_start(butt1, False, 0, 0)

        butt1d = Gtk.Button.new_with_mnemonic(" _Edit Sticky ")
        butt1d.connect("clicked", self.edit_stick, window)
        hbox.pack_start(butt1d, False, 0, 0)

        butt2 = Gtk.Button.new_with_mnemonic(" _Search ")
        butt2.connect("clicked", self.search, window)
        hbox.pack_start(butt2, False, 0, 0)

        butt22 = Gtk.Button.new_with_mnemonic(" Show _All ")
        butt22.connect("clicked", self.show_all_sticks, window)
        hbox.pack_start(butt22, False, 0, 0)

        butt21 = Gtk.Button.new_with_mnemonic(" Show _One ")
        butt21.connect("clicked", self.show_one, window)
        hbox.pack_start(butt21, False, 0, 0)
        ...
        butt3 = Gtk.Button.new_with_mnemonic(" _Hide All ")
        butt3.connect("clicked", self.hide_all, window)
        hbox2.pack_start(butt3, False, 0, 0)

        butt31 = Gtk.Button.new_with_mnemonic(" H_ide One ")
        butt31.connect("clicked", self.hide_one, window)
        hbox2.pack_start(butt31, False, 0, 0)

        butt43 = Gtk.Button.new_with_mnemonic(" _Delete One ")
        butt43.connect("clicked", self.del_one, window)
        hbox2.pack_start(butt43, False, 0, 0)

        butt4 = Gtk.Button.new_with_mnemonic(" Hide _Main ")
        butt4.connect("clicked", self.hide_main, window)
        hbox2.pack_start(butt4, False, 0, 0)

        butt41 = Gtk.Button.new_with_mnemonic(" _Keep Above ")
        butt41.connect("clicked", self.above_one, window)
        hbox2.pack_start(butt41, False, 0, 0)

        butt5 = Gtk.Button.new_with_mnemonic(" E_xit ")
        butt5.connect("clicked", self.exit_all)
        hbox2.pack_start(butt5, False, 0, 0)
