...
class stickWin():
    ...
    def __init__(self, me, head, text):
        ...
        print "Created sticky window", head
...
class stickDoc(Gtk.DrawingArea):
    ...
    def __init__(self, par, head, text):
        ...
        self.fgcolor  = float2col(str2float("#000000"))
        self.bgcolor  = float2col(str2float("#ffffff"))
        self.frcolor  = float2col(str2float("#eeeeee"))
        ...
        self.fd.set_family("fixed")
        self.fd.set_size(44 * Pango.SCALE);
